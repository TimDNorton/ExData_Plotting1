plot4<-function(){
    ...
    par(mfrow=c(2, 2))
    plot(png1$Date_Time, png1$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")
    plot(png1$Date_Time, png1$Voltage, type="l", xlab="datetime", ylab="Voltage")
    ...
    legend('topright', c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), 
           lty=c(1,1), col=c('black', 'red', 'blue'), bty='n', cex=.75)
    plot(png1$Date_Time, png1$Global_reactive_power, type="l", xlab="datetime")
    dev.off()
